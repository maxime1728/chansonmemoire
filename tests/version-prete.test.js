...
test('htmlNouvelleVersion : utilise page_url quand fournie + zero tiret cadratin', () => {
  const html = htmlNouvelleVersion({ token: 'abc', page_url: 'https://chansonmemoire.ca/page-memoire?id=abc' }, 'https://site');
  assert.ok(html.includes('https://chansonmemoire.ca/page-memoire?id=abc'));
